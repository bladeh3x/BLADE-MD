 ...
 * @author : salmanytofficial <https://github.com/Bladeh3x>
...
cmd({
    ...
    async(Void, citel) => {
        let { data } = await axios.get('https://api.github.com/repos/Bladeh3x/BLADE-MD')
        let cap = `Hey ${citel.pushName}\n
*⭐ Total Stars:* ${data.stargazers_count} stars
*🍽️ Forks:* ${data.forks_count} forks
*🍁 Repo:* https://github.com/Bladeh3x/BLADE-MD
...
*Deploy Your Own:*-
https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FBladeh3x%2FBLADE-MD&template=https%3A%2F%2Fgithub.com%2FBladeh3x%2FBLADE-MD`
        let buttonMessaged = {
