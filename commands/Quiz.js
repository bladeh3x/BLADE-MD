...
const quizQuestions = [
...

    {
        ...
        options: ["A. christ", "B. Alextv", "C. mike"],
        correctAnswer: "B"
    },
    ...
    
    {
        ...
        options: ["A. emerald", "B. ruby", "C. diamond"],
        correctAnswer: "C"
    },
    
    {
        question: "What is the element symbol for gold?",
        options: ["A. Au", "B. Gu", "C. Ir"],
        correctAnswer: "A"
    },
    
    {
        question: "What system is used by blind people to read and write ?",
        options: ["A. Morse code", "B. Braille", "C. Phonics"],
        correctAnswer: "B"
    },
    
    {
        question: "how many days are in the month July?",
        options: ["A. 30", "B. 31", "C. 28"],
        correctAnswer: "B"
    },
    ];
